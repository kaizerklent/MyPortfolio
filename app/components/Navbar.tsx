    ...
    <>
      ...
      >
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            Kaizer Klent Auceran<span className="text-white/30">.</span>
          </a>
          ...
          {/* Resume Button → visible on all sizes */}
          <button
        ...
        {menuOpen && (
          <div className="md:hidden absolute top-full left-0 right-0 bg-[#080b14]/95 backdrop-blur-xl border-b border-white/5 px-6 py-6 flex flex-col gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 text-cyan-400 font-mono text-sm hover:text-cyan-300 transition-colors"
            >
      ...
      {/* Resume Modal — covers full screen when open */}
      {resumeOpen && (
